...
#define LAZY_IMPORTER_KHASH(str) FrameWork::LazyImporter::li::detail::khash(str, \
FrameWork::LazyImporter::li::detail::khash_impl( __TIME__ __DATE__ LAZY_IMPORTER_STRINGIZE_EXPAND(__LINE__) LAZY_IMPORTER_STRINGIZE_EXPAND(__COUNTER__), 2166136261 ))

#define lzimpLI_FN(name) FrameWork::LazyImporter::li::detail::lazy_function<LAZY_IMPORTER_KHASH(#name), decltype(&name)>()

#define lzimpLI_FN_DEF(name) FrameWork::LazyImporter::li::detail::lazy_function<LAZY_IMPORTER_KHASH(#name), name>()

#define lzimpLI_MODULE(name) FrameWork::LazyImporter::li::detail::lazy_module<LAZY_IMPORTER_KHASH(name)>()
